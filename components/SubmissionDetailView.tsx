        ...
        <div className="p-6 bg-gradient-to-br from-gray-50 to-white border-b">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded-xl p-4 shadow-md border-l-4 border-teal-500">
              ...
              {/* NOTE: Giữ logic, nhưng class dynamic kiểu bg-${...} có thể không được Tailwind build */}
              <div
                className={`text-xs mt-1 px-2 py-1 rounded-full inline-block bg-${gradeInfo.color}-100 text-${gradeInfo.color}-700`}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-xs text-gray-500 pt-2 border-t border-blue-200">0.25 điểm/câu</div>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-4 border border-green-200">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-xs text-gray-500 pt-2 border-t border-green-200">Tối đa 1.0 điểm/câu</div>
              </div>
            </div>
            ...
            <div className="bg-orange-50 rounded-xl p-4 border border-orange-200">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-xs text-gray-500 pt-2 border-t border-orange-200">0.5 điểm/câu</div>
              </div>
            </div>
          </div>
